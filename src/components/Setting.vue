                ...
                <div class="stages_group" v-for="pipeline in selectedPipelineOptions" :key="pipeline.value">
                    ...
                    >
                        <option
                            ...
                            :selected="isStageSelected(pipeline.value, stage.value)"
                        >
                            {{ stage.label }}
                        </option>
                    </select>
...
export default defineComponent({
    ...
    methods: {
        ...
        isStageSelected(pipelineId, stageId) {
            const selectedStages = this.getPipelineStages(pipelineId).map(String)
            return selectedStages.includes(String(stageId))
        },
